...
st.sidebar.page_link("pages/01_global_map.py", label="🌍 Global Disease Map")
st.sidebar.page_link("pages/02_india_focus.py", label="🇮🇳 India Health Dashboard")
st.sidebar.page_link("pages/03_outbreak_alerts.py", label="🚨 Outbreak Alerts")
st.sidebar.page_link("pages/04_forecasting.py", label="📈 Forecasting & Trends")
st.sidebar.page_link("pages/05_ai_insights.py", label="🤖 AI Analyst")

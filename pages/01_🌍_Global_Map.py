...
st.caption("Interactive choropleth and risk heatmap powered by Disease.sh + WHO GHO data. COVID-19 data: complete historical record Jan 2020 – Dec 2023.")
...
with col1:
    map_mode = st.selectbox("Map Mode", ["Total Cases", "Deaths", "Cases per Million", "Risk Score"])
with col2:
...
with col_left:
    ...
    top10 = df.nlargest(10, "cases")[["country", "cases", "deaths"]].reset_index(drop=True)
    top10.index += 1

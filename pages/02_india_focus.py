...
st.caption("State-level analysis powered by Disease.sh + IHME GHDx India data. COVID-19 data: complete historical record Jan 2020 – Dec 2023.")
...
cases  = india_national.get('cases', 44690000)
deaths = india_national.get('deaths', 530779)
cfr    = round((deaths / cases) * 100, 2) if cases > 0 else 0
kpis = [
    ("Total Cases (2020-23)", f"{cases:,}", "#58a6ff"),
    ("Total Deaths", f"{deaths:,}", "#f85149"),
    ("Case Fatality Rate", f"{cfr}%", "#e3b341"),
    ("Peak Daily Cases", "414,188", "#ff7b72"),
]
